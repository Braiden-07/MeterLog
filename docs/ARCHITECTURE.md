...
Added at G2, transcribed from ADR-012's RBAC decision that the trail is readable by admin **and** auditor ([`admin AND auditor` (DECISIONS.md:559)](DECISIONS.md#L559)), made an enforcement by ADR-014 ([`@RequiresRole('admin', 'auditor')` (DECISIONS.md:638)](DECISIONS.md#L638)).
...
Lives in DECISIONS: [ADR-009](DECISIONS.md#L412) capture · [ADR-010](DECISIONS.md#L460) integrity · [ADR-011](DECISIONS.md#L486) payload and redaction · [ADR-012](DECISIONS.md#L531) scope, RBAC and volume · [ADR-013](DECISIONS.md#L602) bootstrap rows · [ADR-014](DECISIONS.md#L628) read surface · [ADR-015](DECISIONS.md#L705) column naming.
